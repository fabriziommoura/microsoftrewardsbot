...
navegador.find_element('xpath','//*[@id="i0116"]').send_keys('meuemail@gmail.com')
...
#Ciclo para digitar no bing (sou iniciante e n sei otimizar)
...
navegador.find_element('xpath','//*[@id="sb_form_go"]').click()
time.sleep(1)
navegador.find_element('xpath','//*[@id="sb_form_q"]').send_keys('F')
navegador.find_element('xpath','//*[@id="sb_form_go"]').click()
navegador.find_element('xpath','//*[@id="sb_form_q"]').send_keys('i')
navegador.find_element('xpath','//*[@id="sb_form_go"]').click()
navegador.find_element('xpath','//*[@id="sb_form_q"]').send_keys('i')
